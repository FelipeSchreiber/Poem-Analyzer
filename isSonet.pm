...
our @EXPORT_OK = qw(isSonnet);
our @EXPORT = qw(isSonnet);
...
#determina se eh soneto ou nao com base no numero de versos e quantidade de silabas por verso (por padrao o soneto deve ter 14 versos e 10 silabas poeticas por verso)
sub isSonnet{
 my $fd = shift;
